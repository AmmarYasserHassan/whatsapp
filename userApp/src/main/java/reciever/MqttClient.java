...
public class MqttClient {
    ...
    public MqttClient() throws Exception {
        ...
        Consumer consumerUserApp = new DefaultConsumer(channel) {
            @Override
        ...
        channel.basicConsume(QUEUE_NAME, true, consumerUserApp);
    }

    public static void main(String[] args) throws Exception {
        MqttClient client = new MqttClient();
        System.out.println("User app started successfully ");
    }
}
